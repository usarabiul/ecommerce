(function ($) {
    ...
    var leafletBasic = function () {
        if ($('#map-basic').length) {
            ...
            L.tileLayer('https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token=pk.eyJ1IjoibWFwYm94IiwiYSI6ImNpejY4NXVycTA2emYycXBndHRqcmZ3N3gifQ.rJcFIG214AriISLbB6B5aw', {
                maxZoom: 18,
                attribution: 'Map data &copy; <a href="../../../../../../../www.openstreetmap.org/index.html">OpenStreetMap</a> contributors, ' +
                    '<a href="../../../../../../../creativecommons.org/licenses/by-sa/2.0/index.html">CC-BY-SA</a>, ' +
                    'Imagery Â© <a href="../../../../../../../www.mapbox.com/index.html">Mapbox</a>',
    ...
    var choropleth = function () {
        if ($('#map-choropleth').length) {
            ...
            map.attributionControl.addAttribution('Population data &copy; <a href="../../../../../../../www.census.gov/index.html">US Census Bureau</a>');
    ...
    var crsBasic = function () {
        if ($('#map-panes').length) {
            ...
            var cartodbAttribution = '&copy; <a href="../../../../../../../www.openstreetmap.org/copyright.html">OpenStreetMap</a> contributors, &copy; <a href="../../../../../../../carto.com/attribution.html">CARTO</a>';
    ...
    var multiMarkColors = function () {
        if ($('#map-multi-marker-colors').length) {
            ...
            L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
                attribution: '&copy; <a href="../../../../../../../www.openstreetmap.org/copyright.html">OpenStreetMap</a>'
            }).addTo(leaflet);


            // set custom SVG icon marker
            var markerIcon1 = L.divIcon({
                html: `<span class="svg-icon svg-icon-danger svg-icon-3x"><svg xmlns="../../../../../../../www.w3.org/2000/svg.html" xmlns:xlink="../../../../../../../www.w3.org/1999/xlink.html" width="24px" height="24px" viewBox="0 0 24 24" version="1.1"><g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><rect x="0" y="24" width="24" height="0"/><path d="M5,10.5 C5,6 8,3 12.5,3 C17,3 20,6.75 20,10.5 C20,12.8325623 17.8236613,16.03566 13.470984,20.1092932 C12.9154018,20.6292577 12.0585054,20.6508331 11.4774555,20.1594925 C7.15915182,16.5078313 5,13.2880005 5,10.5 Z M12.5,12 C13.8807119,12 15,10.8807119 15,9.5 C15,8.11928813 13.8807119,7 12.5,7 C11.1192881,7 10,8.11928813 10,9.5 C10,10.8807119 11.1192881,12 12.5,12 Z" fill="#7e46f0" fill-rule="nonzero"/></g></svg></span>`,
                bgPos: [10, 10],
                iconAnchor: [20, 37],
                popupAnchor: [0, -37],
            ...
            var markerIcon2 = L.divIcon({
                html: `<span class="svg-icon svg-icon-primary svg-icon-3x"><svg xmlns="../../../../../../../www.w3.org/2000/svg.html" xmlns:xlink="../../../../../../../www.w3.org/1999/xlink.html" width="24px" height="24px" viewBox="0 0 24 24" version="1.1"><g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><rect x="0" y="24" width="24" height="0"/><path d="M5,10.5 C5,6 8,3 12.5,3 C17,3 20,6.75 20,10.5 C20,12.8325623 17.8236613,16.03566 13.470984,20.1092932 C12.9154018,20.6292577 12.0585054,20.6508331 11.4774555,20.1594925 C7.15915182,16.5078313 5,13.2880005 5,10.5 Z M12.5,12 C13.8807119,12 15,10.8807119 15,9.5 C15,8.11928813 13.8807119,7 12.5,7 C11.1192881,7 10,8.11928813 10,9.5 C10,10.8807119 11.1192881,12 12.5,12 Z" fill="#3ed092" fill-rule="nonzero"/></g></svg></span>`,
                bgPos: [10, 10],
                iconAnchor: [20, 37],
                popupAnchor: [0, -37],
                className: 'leaflet-marker'
            ...
            var markerIcon3 = L.divIcon({
                html: `<span class="svg-icon svg-icon-warning svg-icon-3x"><svg xmlns="../../../../../../../www.w3.org/2000/svg.html" xmlns:xlink="../../../../../../../www.w3.org/1999/xlink.html" width="24px" height="24px" viewBox="0 0 24 24" version="1.1"><g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><rect x="0" y="24" width="24" height="0"/><path d="M5,10.5 C5,6 8,3 12.5,3 C17,3 20,6.75 20,10.5 C20,12.8325623 17.8236613,16.03566 13.470984,20.1092932 C12.9154018,20.6292577 12.0585054,20.6508331 11.4774555,20.1594925 C7.15915182,16.5078313 5,13.2880005 5,10.5 Z M12.5,12 C13.8807119,12 15,10.8807119 15,9.5 C15,8.11928813 13.8807119,7 12.5,7 C11.1192881,7 10,8.11928813 10,9.5 C10,10.8807119 11.1192881,12 12.5,12 Z" fill="#ff3551" fill-rule="nonzero"/></g></svg></span>`,
                bgPos: [10, 10],
                iconAnchor: [20, 37],
                popupAnchor: [0, -37],
                className: 'leaflet-marker'
    ...
    var interactiveMap = function () {
        if ($('#map-interactive').length) {
            ...
            // Init Leaflet Map
            L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
                attribution: '&copy; <a href="../../../../../../../www.openstreetmap.org/copyright.html">OpenStreetMap</a> contributors'
            }).addTo(leaflet);
