                            ...
                            <div class="card-body">
                                <div class="tagSearch">
                                    <div class="input-group">
                                        ...
                                        <span class="btn btn-sm btn-success rounded-0 addNewTag" data-url="{{route('admin.productsAction',['new-tag',$product->id])}}" style="cursor:pointer;padding: 8px 15px;"><i class="fa fa-plus"></i></span>
                                    </div>
