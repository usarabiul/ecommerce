 <header class="app-header app-header-dark">
	...
	<div class="top-bar">
		...
		<!-- .top-bar-item -->
		<div class="top-bar-item d-none d-sm-flex top-bar-item-full">
			<!-- .top-bar-search -->
		...
		<div class="top-bar-item top-bar-item-right px-0 d-sm-flex">
			...
			<div class="dropdown-menu">
				...
				<a class="dropdown-item" href="{{route('customer.dashboard')}}">
					<span class="dropdown-icon oi oi-person"></span> My Dashboard
				</a>
	...
	<div class="topbar d-flex align-items-center">
		<nav class="navbar navbar-expand gap-3">
			...
			<div class="top-menu-left d-none d-lg-block">
				<ul class="nav">
				<li class="nav-item">
					<a class="nav-link" href="app-emailbox.html"><i class='bx bx-cart-alt'></i></a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="app-chat-box.html"><i class="bx bx-store-alt"></i> </a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="{{route('index')}}"><i class='bx bx-globe'></i></a>
				</li>
			</ul>
			</div>
						...
						<div class="dropdown-menu dropdown-menu-end">
							...
							<div class="header-message-list">
								<a class="dropdown-item" href="javascript:;">
									<div class="d-flex align-items-center">
										<div class="user-online">
											<img src="{{asset(general()->favicon())}}" class="msg-avatar" alt="user avatar">
										</div>
										<div class="flex-grow-1">
								...
								<a class="dropdown-item" href="javascript:;">
									<div class="d-flex align-items-center">
										<div class="user-online">
											<img src="{{asset(Auth::user()->image())}}" class="msg-avatar" alt="user avatar">
										</div>
										<div class="flex-grow-1">
			...
			<div class="user-box dropdown px-3">
				<a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
					...
					<div class="user-info ps-3">
						<p class="user-name mb-0">{{Str::limit(Auth::user()->name,15)}}</p>
						<p class="designattion mb-0">Administrator</p>
					</div>
				</a>
				<ul class="dropdown-menu dropdown-menu-end">
					<li><a class="dropdown-item" href="{{route('admin.myProfile')}}"><i class="bx bx-user"></i><span>My Profile</span></a>
					</li>
					<li><a class="dropdown-item" href="{{route('customer.dashboard')}}"><i class='bx bx-home-circle'></i><span>My Dashboard</span></a>
					</li>
					<li>
